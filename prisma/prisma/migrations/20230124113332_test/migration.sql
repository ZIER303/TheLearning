...
-- CreateTable
CREATE TABLE "UserPereference" (
    "id" TEXT NOT NULL,
    "emailUpdates" BOOLEAN NOT NULL,
    "userId" TEXT NOT NULL,

    CONSTRAINT "UserPereference_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "UserPereference_userId_key" ON "UserPereference"("userId");
...
-- AddForeignKey
ALTER TABLE "UserPereference" ADD CONSTRAINT "UserPereference_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
