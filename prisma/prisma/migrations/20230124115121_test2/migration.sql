/*
  ...
  - You are about to drop the `UserPereference` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "UserPereference" DROP CONSTRAINT "UserPereference_userId_fkey";

-- AlterTable
ALTER TABLE "User" ADD COLUMN     "userPreferenceId" TEXT;

-- DropTable
DROP TABLE "UserPereference";
